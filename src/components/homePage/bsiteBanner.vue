<template>
  <div v-if="itemList && itemList.length>0" class="bsiteBanner w-full flex items-center justify-around py-3">
    <Carousel class="custom-carousel" :autoplay="3000">
      <Slide class="wrap-item bg-c_background py-2" v-for="(item, index) in itemList" :key="index">
