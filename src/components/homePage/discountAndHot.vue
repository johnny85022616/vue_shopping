<template>
  <div class="discountAndHot w-full mt-10">
    <div class="w-full pt-11 pb-3 box-border bg-c_background rounded-lg relative">
      <div class="head flex items-center justify-between h-[46px] text-c_dune bg-c_white border-2 border-solid border-c_silver1 rounded-md mt-[-58px] mr-4 mb-2 ml-4 p-2">
        ...
        <div class="h-100 flex items-center text-c_mine_shaft">
          <div class="box-border rounded-2xl text-sm text-center">
            <a class="flex items-center text-c_dodger_blue no-underline" :href="'https://event.shopping.friday.tw/event/202111/20211122-lookmore/index.html?pids=' + promotionId" target="_blank">看更多
