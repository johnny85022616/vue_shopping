...
export function getCampaignUI(data: campaignInfo /** 活動資料 */, myOwnCampaignIds = [] /** 已領取的CampaignId */) {
  ...
  //     discountAmount = discountExsitedAry[1];
  //   } else {
  //     // 免費情境
  //     discountType = 'F';
  //     discountAmount = -1;
  ...
  //   switch (discountType) {
  //     case 'R':
  //       n = isPercentage ? parseInt(discountExsitedAry[1] * 100) : discountExsitedAry[1].split('.')[1];
  //       output = prefix1 + '<font>' + n.replace(/^0/i, '') + '</font>' + suffix1;
  //       break;
  //     case 'A':
  //       output = prefix2 + '<font>' + discountExsitedAry[1] + '</font>' + suffix2;
  //       break;
  //     case 'F':
  //       output = prefix3 + '免費';
  //       break;
  ...
  //     switch (discountType) {
  //       case 'R':
  //         campaignPageTitle = `${rule}送${parseInt(discountExsitedAry[1] * 100)}%購物金`;
  //         break;
  //       case 'A':
  //         campaignPageTitle = `${rule}送${discountExsitedAry[1]}元購物金`;
  //         break;
  //     }
  //     break;
